	...
	<main id="primary" class="site-main">
		...
		<div class="custom-header d-none d-md-none d-lg-block">
			<div class="custom-nav-links me-5 ">
				...
				<a class="custom-link text-hover-background-swipe " href="../">About</a>
		...
		<div id="smooth-wrapper" class="pushable-content">
			<div id="smooth-content">
				...
				<section class="sk__article-1-header sk__parallax-header sk__animated-header sk__header-y-l sk__article-header dark-shade-5-border ">
					<div class="sk__parallax-header-image sk__parallax-header-image2 sk__absolute sk__image-back-cover sk__filter-city"></div>
					<div class="sk__tint-light sk__absolute"></div>

					<div class="container sk__supercontainer">
						<div class="row text-center">
							<div class="col-12">
								<h1 class="super-heading">CONTACT</h1>
				...
				<section class="sk__project-body">
					<div class="container sk__powercontainer">
						<div class="row">
							...
							<div class="col-xl-6 offset-xl-3 sk__project-body-info-col mt-4 mt-xl-0 pt-5 pt-xl-0 text-center text-sm-start">
								<p class="text-danger animated-element text-end fs-6" style="font-size:xx-small;">IF YOU HAVE ANY QUESTION DON'T HESITATE TO CALL US</p>
								<h4 class="animated-element">+94 76 368 7242 - Iruni Kalupahana (Director of Internationals)</h4>
<!-- 
