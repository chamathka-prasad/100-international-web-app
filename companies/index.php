...
<head>
	...
	<title>100 international | Our Companies</title>
	...
	<main id="primary" class="site-main">
		...
		<div class="custom-header d-none d-md-none d-lg-block">
			<div class="custom-nav-links me-5 ">
				...
				<a class="custom-link text-hover-background-swipe gradiendColorAdd" href="#">Companies</a>
				<a class="custom-link text-hover-background-swipe" href="../team/">Team</a>
				<a class="custom-link text-hover-background-swipe" href="#">Contact</a>
			</div>
								...
								<section class="sk__parallax-background-section sk__hero-item-theme-style ">
									...
									<div class="hero-h1-box">
										...
										<div class="cover-text-wrapper">
											<h3 class="animated-element phase-1 text-center text-sm-start text-white" style="font-family:'agfb';font-size:5rem;">SCHOOL OF</strong></h3>
										</div>
										<div class="cover-text-wrapper">
											<h1 class="hero-h1 animated-element phase-1 text-center text-md-start text-white " style="font-family:'agfb';font-size:5rem;">Creativity</h1>
										</div>
									...
									<div class="hero-box-bottom-left text-center text-sm-start">
										<a class="btn btn-outline-light animated-element phase-1 mb-4 text-hover-background-swipe-button" href="../course/"  role="button">CHOOSE School Of Creativity</a>
							...
							<div class="carousel-item zooming hero-slide-2 sk__hero-slider-item sk__image-back-cover">
								<section class="sk__parallax-background-section sk__hero-item-center-center">
									...
									<div class="mb-2 text-center">
										...
										<span class="animated-element phase-1"></span>
										<div class="cover-text-wrapper">
											<h1 class="hero-h1 animated-element phase-1">READY TO BE THE NEXT COMPANY <br>?</h1>
										</div>
