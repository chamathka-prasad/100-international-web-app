							...
							<div class="carousel-item zooming active hero-slide-1 sk__hero-slider-item sk__image-back-cover">
								...
								<section class="sk__video-background-section sk__hero-item-theme-style">
									...
									<div class="sk__video-container sk__parallax-hero-video sk__absolute sk__image-back-cover">
										...
										<video class="sk__video" preload="none" poster="assets/images/Companyimages/logo.png" autoplay="" loop="" muted="" playsinline="">
											<source src="assets/video/company/100.mp4" type="video/mp4">Your browser does not support HTML5 video.
										</video>
									</div>
									...
									<div class="hero-box-bottom-left text-center text-sm-start">
										...
										<!-- <div class="cover-text-wrapper">
											<h3 class="animated-element phase-1 text-center text-sm-start text-white">Our Latest <strong>Project</strong></h3>
										</div>
										...
										<a class="btn btn-outline-light animated-element phase-1 mb-4 text-hover-background-swipe-button" href="#about-us" role="button">View More</a>
							 -->
									</div>
