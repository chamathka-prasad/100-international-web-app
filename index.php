	...
	<main id="primary" class="site-main">
		...
		<div id="smooth-wrapper" class="pushable-content">
			<div id="smooth-content">
				...
				================================================== -->
				<section class="sk__cta-warp position-relative sk__image-back-cover" style="padding: 50px;">
					<div class="container sk__powercontainer">
						<div class="row">
							<div class="col text-center">
								...
								<!-- <p>Unlock your creative potential with 100 International's Professional Video Editing and Cinema Course, a unique chance to master industry-leading tools like Premiere Pro, DaVinci Resolve, and After Effects. This comprehensive two-month online program, complete with 8 practical assignments and expert guidance, ensures hands-on learning and skill enhancement. Upon completion, you'll earn a professional certificate and qualify for a prestigious 6-month internship with 100 International, giving you invaluable real-world experience. Don’t miss this incredible opportunity to elevate your editing skills and embark on a journey toward a successful creative career!</p> -->
					...
					<div class="container sk__powercontainer">
						<div class="row">
							...
							<div class="col-xl-6 col-xxl-7 sk__project-body-image-col">
								<img src="assets/images/Companyimages/courses/course2.png" alt="Sample image.">
							</div>
...
<div class="row">
    ...
    <div class="col-12 d-flex justify-content-center">
        <a class="btn btn-outline-light animated-element text-hover-background-swipe-button" href="course/" role="button">View Course Details -></a>
				...
				<section class="sk__gallery-section sk__py-m" style="padding: 0px;">
					...
					<div class="container sk__supercontainer position-relative">
						...
						<div class="row footer-main text-center text-sm-start">
							...
							<div class="col-sm-12 col-md-6 col-lg-3 footer-main-small-col widget_nav_menu">
								...
								<ul>
									<li>
										<a href="#" class="footer-main-links gradient-links">Course</a>
									</li>
									<li>
										<a href="#" class="footer-main-links gradient-links">Our Team</a>
									</li>
									<!-- <li>
	...
	<script>
		...
		// displacementImage: 'assets/images/companyImages/logo.jpeg',
