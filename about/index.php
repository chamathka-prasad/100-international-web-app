	...
	<main id="primary" class="site-main">
		...
		<div class="custom-header d-none d-md-none d-lg-block">
			<div class="custom-nav-links me-5 ">
				...
				<a class="custom-link text-hover-background-swipe gradiendColorAdd" href="#">About</a>
		...
		<div id="smooth-wrapper" class="pushable-content">
			<div id="smooth-content">
							...
							<div class="col">
								...
								<div class="row sk__heading-spacer-l">
									<div class="col-12 col-xl-10 offset-xl-1 text-center">
										<h1 class="h1-small mb-3 pt-4 pb-1">AT THE CORE, <br> <strong class="text-warning">WE MAKE COMPANIES FOR YOUR INNOVATIVE IDEAS</strong> . <br>BUT THE POINT IS <br><strong class="text-warning">WE SELL HERE OUR CREATIVITY</strong> <br>TO ENTER THE BUSINESS WORLD.</h1>
										<!-- <p class="p-v2 skills-subhead"></p> -->
									</div>
								</div>
				...
				<!-- categories -->
				<iframe src="../categorySlider.php" class="iframe-container mt-3"></iframe>
				<!-- categories -->
